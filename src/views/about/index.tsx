...
const AboutView = () => {
  ...
  return (
    <View className="py-40 relative bg-green">
      <ViewContent className="relative flex flex-col justify-center gap-16 items-start">
            ...
            <div className="w-full max-w-3xl flex flex-col gap-6">
              ...
              >
                ...
                <p className="text-gray-200 font-medium text-sm sm:text-base lg:text-lg">
                  Somos un grupo empresarial internacional que busca
                  consolidarse a través de un plan estratégico para brindar
                  apoyo integral al productor, desde la concepción de su idea
                  hasta la comercialización.
                </p>

                <p className="text-gray-400 font-medium text-sm sm:text-base lg:text-lg">
                  Este equipo, con experiencia multidisciplinaria en los
                  sectores agropecuario, empresarial y de innovación, está
                  comprometido con el desarrollo rural a través de soluciones
                  innovadoras. Su objetivo es mejorar el desarrollo humano,
                  promover la sostenibilidad y fortalecer la competitividad de
                  la agroindustria.
                </p>
              </div>
            </div>
        ...
        <div
          ...
          className="bg-blue-100/30 rounded-4xl px-6 py-6 max-w-2xl relative z-3 backdrop-blur-md flex flex-col gap-4"
          style={{
            // @ts-ignore
